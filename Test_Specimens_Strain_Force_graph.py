...
a=20. #mm in radial direction is the full width of the crack or diameter of ellipse.
d=1. #mm in chardist
b=20. #mm in axial direction is the full width of the crack or diameter of ellipse.
angleofweakness=0. #degrees, defined from b to the axial direction
DamagedLayers=4. #34 if mongolayup
...
plt.plot(TotalStrain, TotalForces)
plt.show()
...
with open('text3.txt', 'w') as f:
    ...
    writer.writerows(zip(TotalStrain, TotalForces))
quit()
